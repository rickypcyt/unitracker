        ...
        <div className="p-4 space-y-4">
          {loading ? <div className="flex justify-center py-8">
            ...
            duration: 0.2
                  ...
                  return <p className="text-sm text-[var(--text-secondary)] mt-1">
                            Started {created ? formatDistanceToNowStrict(created, {
                      addSuffix: true
                    }) : 'Unknown'}
                          </p>;
                })()}
                  ...
                  handleResumeSession(session.id);
                      ...
                      <button onClick={() => handleFinishSession(session.id)} className="p-2 rounded-md text-gray-500 hover:text-gray-400 transition-colors" title="Finish session" aria-label="Finish session">
                        <Check size={18} />
                      </button>
                      <button onClick={() => handleDeleteSession(session.id)} className="p-2 rounded-md text-red-600 hover:text-red-500 transition-colors" title="Delete session" aria-label="Delete session">
                        <Trash2 size={18} />
                      </button>
                    </div>
                  </div>

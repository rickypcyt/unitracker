...
const DayTooltip = ({ date, tasks, studiedHours }: DayTooltipProps) => {
  ...
  return (
    <div className="absolute z-[9999] bg-neutral-900 border-2 border-neutral-800 rounded-lg p-3 shadow-lg min-w-[200px] transform -translate-y-full -translate-x-1/2 left-1/2 -top-2">

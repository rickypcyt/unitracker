  ...
  return (
    <div>
      <div className="maincard">
        ...
        >
          <FaChartLine className="mr-2" style={{ color: 'var(--accent-primary)' }} /> Progress Tracker
        </h2>
        
        <div className="space-y-6">
          <div className="relative pt-1">
            <div className="flex mb-2 items-center justify-between gap-4">
              <div className="flex-1 overflow-hidden h-2 rounded"
              ...
              <span className="text-s font-semibold inline-block ml-2"
                style={{ color: 'var(--accent-primary)', minWidth: '32px', textAlign: 'right' }}
              >
          ...
          <p className="text-lg font-medium flex items-center justify-center gap-2"
            style={{ color: 'var(--text-primary)' }}
          >
            <span className="text-3xl font-bold" style={{ color: 'var(--accent-primary)' }}>{completedTasks}</span> 
            out of 
            <span className="text-3xl font-bold" style={{ color: 'var(--accent-tertiary)' }}>{totalTasks}</span> 
            tasks completed
          </p>

          <div className="flex justify-between items-center">
            <div style={{ color: 'var(--text-secondary)' }}>
              <FaTrophy className="inline mr-2" style={{ color: 'var(--accent-primary)' }} />
              Next milestone: {getNextMilestone()} tasks
            </div>
            <div style={{ color: 'var(--text-secondary)' }}>
              <FaCheckCircle className="inline mr-2" style={{ color: 'var(--accent-primary)' }} />
      ...
      {toast.visible && (
        <div className="fixed top-4 right-4 z-50 px-4 py-3 rounded shadow-lg animate-slideIn"
